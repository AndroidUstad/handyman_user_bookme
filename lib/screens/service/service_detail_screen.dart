        ...
        Wrap(
          ...
          children: List.generate(data.where((element) => element.slot.validate().isNotEmpty).length, (index) {
            ...
            return Container(
              ...
              child: Text('${value.day.capitalizeFirstLetter()}', style: secondaryTextStyle(size: 18, color: primaryColor)),
            );
          }),
        ),
      ],
          ...
          children: [
            AnimatedScrollView(
              ...
              children: [
                ...
                24.height,
                relatedServiceWidget(serviceList: snap.data!.relatedService.validate(), serviceId: snap.data!.serviceDetail!.id.validate()),
              ],
            ),
            Positioned(
              bottom: 16,
