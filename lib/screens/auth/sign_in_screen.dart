...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void googleSignIn() async {
    ...
    await authService.signInWithGoogle().then((value) async {
      ...
      appStore.setLoading(false);
      toast("umair is great "+e.toString());
      print("error brad wada hi"+e.hashCode.toString());
  ...
  Widget _buildRememberWidget() {
    return Column(
      children: [
        ...
        TextButton(
          onPressed: () {
            if (getStringAsync(PROVIDER_PLAY_STORE_URL).isNotEmpty && getStringAsync(PROVIDER_APPSTORE_URL).isNotEmpty) {
              if (isAndroid) {
